        ...
        <tbody>
            @forelse ($prices as $price)
                <tr class="border-b border-gray-100 dark:border-white/5">
                    ...
                    <td class="px-3 py-2 text-right">${{ number_format((float) $price->input_price_per_million_usd, 8) }}</td>
                    <td class="px-3 py-2 text-right">{{ $price->cached_input_price_per_million_usd !== null ? '$'.number_format((float) $price->cached_input_price_per_million_usd, 8) : 'Sama dengan input' }}</td>
                    <td class="px-3 py-2 text-right">${{ number_format((float) $price->output_price_per_million_usd, 8) }}</td>
